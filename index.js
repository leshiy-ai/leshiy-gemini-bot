...
const monolithContext = {
    ...
    loadS3ChatHistory: worker.loadS3ChatHistory,
    clearS3ChatHistory: worker.clearS3ChatHistory,
    loadChatIndex: worker.loadChatIndex,
    saveChatIndex: worker.saveChatIndex,
    createS3Chat: worker.createS3Chat,
    deleteS3Chat: worker.deleteS3Chat,
    renameS3Chat: worker.renameS3Chat,
