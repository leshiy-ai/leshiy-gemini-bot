...
// ✅ *** 2.30a. callPollinationsPolly (Pollinations.ai: Polly - free model) ***
/**
 * Генерирует текстовый ответ через Pollinations.ai (OpenAI-compatible).
 * Поддерживает системный промпт и унифицированный контракт.
 */
async function callPollinationsPolly(config, history, messageText, envData) {
...
// ✅ *** 2.30b. callPollinationsGrok (Pollinations.ai: Grok) ***
/**
 * Генерирует текстовый ответ через Pollinations.ai (OpenAI-compatible).
 * Поддерживает системный промпт и унифицированный контракт.
 */
